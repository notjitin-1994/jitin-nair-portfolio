...
- Name: home.spec.ts >> Jitin Nair Portfolio Home Page >> projects section is visible
...
Locator: locator('h3:has-text("Predator Nexus V4.0")').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('h3:has-text("Predator Nexus V4.0")').first()
