...
- Name: home.spec.ts >> Jitin Nair Portfolio Home Page >> terminal renders and processes commands
...
Locator: locator('text=jitin@nexus:~$').first()
Expected: visible
Timeout: 15000ms
...
Call log:
  ...
  - waiting for locator('text=jitin@nexus:~$').first()
