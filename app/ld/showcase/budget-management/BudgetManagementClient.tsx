    ...
    <section className="relative overflow-hidden px-5 pt-32 pb-16 bg-[#030303]">
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-10 max-w-4xl">
          ...
          >
            Optimizing <br />
            <span className="text-emerald-400 italic font-serif">the Investment.</span>
          </motion.h1>
          <motion.p
          ...
          >
            Strategic resource allocation, ROI optimization, and intelligent financial architectures that maximize the impact of enterprise learning.
          </motion.p>
        </div>
      </div>
    </section>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <Reveal>
          ...
          <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl mb-10 leading-tight">
            Redefining L&D as a Profit Center
          </h2>
          <div className="space-y-6 text-lg text-neutral-400 leading-relaxed font-light">
            <p>
              Traditional L&D operates as a cost center, constantly defending its budget against competing enterprise priorities. 
              To shift this paradigm, we must pivot from discretionary spend to high-yield investment portfolios.
            </p>
            <p>
              My approach treats L&D budget management as strategic capital allocation. By synthesizing zero-based budgeting principles with the 
              efficiency gains of AI platforms like <span className="text-emerald-400 font-medium mx-1">Smartslate</span>, 
              I architect financial models that aggressively reduce operational overhead while scaling performance impact.
            </p>
            <p className="border-l-2 border-emerald-500/50 pl-6 py-2 italic text-emerald-50/90 bg-emerald-500/5 rounded-r-lg">
              "It’s not about doing more with less. It’s about leveraging AI-driven cost structures to reallocate capital from maintenance to innovation."
            </p>
          </div>
        </Reveal>
      </div>
  ...
  const tools = [
    {
      ...
      description: (
        <span>
          A sophisticated financial modeling framework that forecasts the business impact of learning interventions. 
          By cross-referencing projected performance gains against development costs, it ensures that every dollar is deployed toward high-leverage business objectives.
        </span>
      ),
      icon: TrendingUp,
      colSpan: "lg:col-span-2",
      tags: ["Financial Modeling", "Forecasting", "ROI"],
      status: "Strategic",
    },
    {
      id: "smartslate-efficiency",
      title: "Smartslate OPEX Reduction",
      subtitle: "AI Optimization",
      description: "Leveraging Smartslate's multi-agent architecture to drastically compress content development cycles. This translates directly into reduced reliance on external vendors and lower internal labor costs, freeing up budget for strategic initiatives.",
      icon: Cpu,
      colSpan: "lg:col-span-1",
      tags: ["AI", "Cost Reduction", "Smartslate"],
      status: "Active",
    },
    {
      id: "vendor-consolidation",
      title: "Vendor Ecosystem Consolidation",
      subtitle: "Strategic Sourcing",
      description: "Rigorous auditing of external platforms and content libraries to eliminate redundancies. Streamlined procurement strategies negotiate enterprise-wide licenses for maximum cost efficiency.",
      icon: Briefcase,
      colSpan: "lg:col-span-1",
      tags: ["Procurement", "Auditing", "Negotiation"],
      status: "System-wide",
    },
    {
      id: "zero-based",
      title: "Zero-Based Allocation",
      subtitle: "Justified Investment",
      description: "Moving away from legacy rollover budgets. Every initiative must prove its strategic alignment and projected ROI from a baseline of zero, ensuring agile reallocation of funds to the highest-priority enterprise goals.",
      icon: PieChart,
      colSpan: "lg:col-span-2",
      tags: ["Agile Finance", "Zero-Based", "Strategy"],
      status: "Governance",
    },
  ];
      ...
      <div className="mx-auto max-w-6xl">
        <Reveal className="mb-16">
          ...
          <h2 className="text-4xl font-bold tracking-tight text-white sm:text-5xl">
            The Budget Management <span className="italic font-serif text-emerald-400">Toolkit.</span>
          </h2>
        </Reveal>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <Reveal>
            ...
            <h2 className="text-4xl font-bold tracking-tight text-white sm:text-5xl mb-8 leading-tight">
              Designing How <br />
              <span className="text-emerald-400 italic font-serif">Capital Performs.</span>
            </h2>
            <p className="text-lg text-neutral-400 leading-relaxed font-light mb-8">
              Strategic L&D leadership requires moving beyond mere cost control. I architect financial systems that dynamically allocate resources to where they generate the highest cognitive and business yield.
            </p>
            
            <div className="space-y-4">
              {[
                { title: "Dynamic Reallocation", desc: "Shifting budget rapidly based on emerging business needs.", icon: Zap },
                { title: "AI-Driven Cost Compression", desc: "Using Smartslate to reduce per-asset development costs by up to 70%.", icon: Cpu },
                { title: "Value Analytics", desc: "Connecting learning spend directly to enterprise KPI improvements.", icon: BarChart4 },
              ].map((item, i) => (
...
type CommandTab = "allocation" | "smartslate";
...
function CommandCenterSection() {
  const [activeTab, setActiveTab] = useState<CommandTab>("allocation");
  const [state, setState] = useState<CommandState>("idle");
  const [smeState, setSmeState] = useState<SmeState>("idle");
  const reduced = useReducedMotion();

  const tabs: { id: CommandTab; label: string }[] = [
    { id: "allocation", label: "ROI Projection Model" },
    { id: "smartslate", label: "Smartslate Efficiency" },
  ];

  const states: { id: CommandState; label: string; icon: any }[] = [
    { id: "idle", label: "0. Baseline", icon: Activity },
    { id: "diagnostic", label: "1. Cost Audit", icon: Search },
    { id: "engineering", label: "2. Modeling", icon: Brain },
    { id: "designing", label: "3. Allocation", icon: Layers },
    { id: "complete", label: "4. Execution", icon: Rocket },
  ];
      ...
      <div className="mx-auto max-w-6xl relative z-10">
        <Reveal className="mb-16">
          ...
          <p className="text-lg text-neutral-400 leading-relaxed font-light max-w-3xl">
            Financial modeling in action. Watch as budget requests are analyzed against historical ROI data, optimized for cost-efficiency, and approved for maximum strategic impact.
          </p>
        </Reveal>
            ...
            <div className="grid lg:grid-cols-[1fr_2.5fr] gap-8 items-start">
              ...
              <div className="relative min-h-[500px] rounded-[2.5rem] border border-white/10 bg-[#0a0a0a] p-10 overflow-hidden shadow-2xl group/display">
                ...
                <div className="h-full flex flex-col items-center justify-center text-center py-12">
                    ...
                    <div className="relative p-6 rounded-3xl bg-white/[0.03] border border-white/10 shadow-2xl">
                      <div className="flex items-center gap-4">
                        ...
                        <div className="text-left">
                          <div className="text-sm font-bold text-white mb-0.5">budget_proposals_q3.xlsx</div>
                  ...
                  <h3 className="text-2xl font-bold text-white mb-2 tracking-tight">Financial Baseline Established</h3>
                  <p className="text-neutral-500 text-sm max-w-sm mb-10 font-light leading-relaxed">
                    All departmental requests ingested. Ready for zero-based scrub and strategic alignment verification.
                  </p>
                  ...
                  >
                    ...
                    <span className="relative z-10 flex items-center gap-2">
                      Initiate Cost Audit <ArrowRight className="h-4 w-4" />
                    </span>
                  </button>
                </div>
              )}
                  ...
                  {state === "diagnostic" && (
                    <div className="space-y-8 py-6">
                      ...
                      <div className="space-y-4">
                        {[
                          { text: "Scanning Vendor Redundancies", delay: 0 },
                          { text: "Benchmarking Historical Spends", delay: 0.8 },
                          { text: "Optimization: OPEX Waste Identified", delay: 1.6, highlight: true },
                        ].map((node, i) => (
                          <motion.div
                            key={node.text}
                      ...
                      >
                        ...
                        >
                          Process to Modeling <ArrowRight className="h-3 w-3" />
                        </button>
                      </motion.div>
                    </div>
                  )}
                  ...
                  {state === "engineering" && (
                    <div className="h-full flex flex-col items-center justify-center py-10 relative">
                      <div className="relative w-64 h-64 mb-12">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                          <BarChart4 className="h-10 w-10 text-emerald-500/30" />
                        </div>
                      </div>
                      <motion.button
                    ...
                    <div className="space-y-10 py-4">
                      <div className="grid grid-cols-2 gap-8">
                        <div className="space-y-6">
                          <div className="text-emerald-500/60 font-mono text-[10px] uppercase tracking-[0.4em]">Drafting Budget</div>
                          <div className="space-y-4">
                            {[
                              { label: "Target", val: "Enterprise Capability Building" },
                              { label: "Opex Strategy", val: "Shift 30% to AI tooling" },
                              { label: "KPIs", val: "Performance Yield Optimization" },
                            ].map((item, i) => (
                        ...
                        <div className="relative rounded-2xl border border-white/5 bg-white/[0.01] overflow-hidden p-6 flex items-center justify-center">
                          ...
                          <PieChart className="h-16 w-16 text-emerald-500/20" />
                          <motion.div
                            className="absolute inset-0 bg-emerald-500/5"
                            animate={{ top: ["0%", "100%", "0%"] }}
                    ...
                    <div className="h-full flex flex-col py-2">
                      <div className="flex justify-between items-start mb-8">
                        <div>
                          ...
                          <h3 className="text-2xl font-bold text-white tracking-tight">Optimized L&D Portfolio</h3>
                        </div>
                        <div className="text-right">
                          <div className="text-[10px] text-neutral-500 uppercase tracking-[0.2em] mb-1">Ledger ID</div>
                          <div className="font-mono text-xs text-emerald-500/80">#LD-FIN-2024-Q3</div>
                        </div>
                      </div>

                      <div className="grid grid-cols-3 gap-4 mb-8">
                        {[
                          { label: "Capital Efficiency", val: "+22%", sub: "Quarter-over-Quarter" },
                          { label: "Vendor Spend", val: "-18%", sub: "Optimized via AI" },
                          { label: "Impact Yield", val: "High", sub: "Strategic Alignment" },
                        ].map((stat) => (
                      ...
                      <div className="flex-grow p-6 rounded-3xl bg-emerald-500 text-[#062a1d] relative overflow-hidden group/card shadow-[0_20px_50px_rgba(16,185,129,0.2)]">
                        ...
                        <div className="relative z-10">
                          <div className="text-[10px] font-bold uppercase tracking-widest mb-2 opacity-60">Investment Summary</div>
                          <p className="text-lg font-bold leading-tight mb-4">
                            Budget restructured for high-leverage strategic initiatives.
                          </p>
                          <ul className="space-y-2">
                            {["Zero-Based Alignment Confirmed", "Internal Production Scaled", "Legacy Cost Centers Eliminated"].map((item) => (
...
/* ---------- 5. Smartslate Efficiency Direct Pipeline ---------- */
function SmePipelineDemo({ state, setState }: { state: SmeState; setState: (s: SmeState) => void }) {
  ...
  const states: { id: SmeState; label: string; icon: any }[] = [
    { id: "idle", label: "Cost Intake", icon: Briefcase },
    { id: "crystallizing", label: "AI Translation", icon: Sparkles },
    { id: "forging", label: "Resource Modeling", icon: Hammer },
    { id: "validating", label: "Yield Check", icon: ShieldCheck },
    { id: "complete", label: "Smartslate Deploy", icon: Rocket },
  ];
        ...
        >
          {state === "idle" && (
            <div className="h-full flex flex-col items-center justify-center text-center py-12">
              <div className="relative mb-8 group/file">
                ...
                <div className="relative p-6 rounded-3xl bg-white/[0.03] border border-white/10 shadow-2xl">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="text-left">
                      <div className="text-sm font-bold text-white mb-0.5">legacy_vendor_spend.pdf</div>
                      <div className="flex gap-3 text-[10px] text-neutral-500 font-mono uppercase tracking-tight">
                        <span>1.2 MB</span>
                        <span className="text-emerald-500/60">•</span>
              ...
              <h3 className="text-2xl font-bold text-white mb-2 tracking-tight">Legacy Costs Captured</h3>
              <p className="text-neutral-500 text-sm max-w-sm mb-10 font-light leading-relaxed">
                Traditional expenditure data registered. Ready to model AI-driven cost reductions via Smartslate.
              </p>
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000" />
                <span className="relative z-10 flex items-center gap-2">
                  Initiate AI Compression <ArrowRight className="h-4 w-4" />
                </span>
              </button>
            </div>
          )}
          ...
          {state === "crystallizing" && (
            <div className="space-y-8 py-6">
              ...
              <div className="relative p-6 rounded-2xl border border-white/5 bg-white/[0.02] font-mono text-sm leading-relaxed text-neutral-400">
                ...
                >
                  <p className="relative inline-block">
                    "External vendor quote: $45,000 for standard SCORM modules..."
                    <motion.div 
                  ...
                  <div className="grid grid-cols-1 gap-3 pt-6">
                    {[
                      { text: "Smartslate In-Housing Engine", delay: 0 },
                      { text: "Automated Pipeline Generation", delay: 1 },
                      { text: "Cost Reduction Modeling", delay: 2 },
                    ].map((node, i) => (
                      <motion.div
                        key={node.text}
              ...
              <motion.button
                ...
                className="text-xs font-bold text-emerald-400 uppercase tracking-widest hover:text-emerald-300 transition-colors flex items-center gap-2"
              >
                Proceed to Modeling <ArrowRight className="h-3 w-3" />
              </motion.button>
            </div>
          )}
            ...
            <div className="h-full flex flex-col">
              <div className="grid grid-cols-2 gap-4 flex-grow">
                <div className="p-6 rounded-2xl border border-white/5 bg-white/[0.01] flex flex-col">
                  <span className="text-[10px] text-neutral-500 uppercase tracking-widest mb-4">Traditional Cost</span>
                  <div className="space-y-2 font-mono text-[10px] text-neutral-600">
                    <p>"High external dependency. Slow time-to-market. Extensive rework cycles..."</p>
                  </div>
                </div>
                <motion.div 
                  initial={{ opacity: 0, x: 20 }}
                ...
                >
                  <span className="text-[10px] text-emerald-500 uppercase tracking-widest mb-4 font-bold">Smartslate Advantage</span>
                  <div className="space-y-3 font-mono text-[10px] text-emerald-400/80">
                    ...
                    <div className="border-b border-emerald-500/20 pb-2 flex justify-between">
                      ...
                      <span className="opacity-50">10x</span>
                    </div>
          ...
          {state === "validating" && (
            <div className="h-full flex flex-col items-center justify-center text-center">
              ...
              <h3 className="text-xl font-bold text-white mb-2">Financial Validation</h3>
              <p className="text-neutral-500 text-xs mb-10 font-light uppercase tracking-widest">
                Forecasted yield verified. Sign-off for deployment.
              </p>
              <button
                onClick={() => setState("complete")}
            ...
            <div className="h-full flex flex-col py-2">
              <div className="flex justify-between items-start mb-8">
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-white tracking-tight">Smartslate Integration Active</h3>
                </div>
                <div className="text-right">
                  <div className="text-[10px] text-neutral-500 uppercase tracking-[0.2em] mb-1">Status</div>
                  <div className="font-mono text-xs text-emerald-500/80">OPTIMIZED</div>
                </div>
              </div>

              <div className="grid grid-cols-2 gap-4 mb-8 flex-grow">
                {[
                  { title: "Cost Reduction", desc: "Sustainable OPEX decrease" },
                  { title: "Velocity Boost", desc: "Agile go-to-market speed" },
                ].map((item) => (
      ...
      <div className="mx-auto max-w-6xl relative z-10 text-center">
        <Reveal>
          <h2 className="text-4xl font-bold leading-tight tracking-tight text-white sm:text-6xl max-w-3xl mx-auto">
            Ready to <span className="text-emerald-400 italic font-serif">Optimize</span> your L&D Budget?
          </h2>
          <p className="mt-8 max-w-xl mx-auto text-lg text-neutral-400 font-light">
            Architecting modern, scalable capability engines that maximize your investment.
          </p>
...
function DiagnosticVision() {
  return (
    <div className="mb-12 text-left">
      <Reveal>
        <h3 className="text-xl font-bold text-white mb-4">Vision: The Investment Diagnostic</h3>
        <p className="text-neutral-400 text-sm max-w-2xl mb-8 leading-relaxed">
          True budget management requires distinguishing between cost-centers and value-drivers. We analyze financial streams to reallocate waste into strategic learning leverage.
        </p>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            { step: "Data Ingestion", desc: "Aggregation of departmental spend data." },
            { step: "Zero-Based Scrub", desc: "Challenging historical rollovers." },
            { step: "Strategic Alignment", desc: "Tying dollars to business outcomes." },
          ].map((item, i) => (
...
function CrystallizationVision() {
  return (
    <div className="mb-12 text-left">
      <Reveal>
        <h3 className="text-xl font-bold text-white mb-4">Vision: AI-Driven Capital Efficiency</h3>
        <p className="text-neutral-400 text-sm max-w-2xl mb-8 leading-relaxed">
          Scaling capability without scaling costs. Smartslate’s architecture provides an unparalleled mechanism to drive down the variable costs of content production, maximizing the yield of every budget dollar.
        </p>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            { step: "Vendor Assessment", desc: "Identifying redundant external spend." },
            { step: "AI Implementation", desc: "Routing work through Smartslate agents." },
            { step: "Yield Capture", desc: "Reinvesting savings into new capabilities." },
          ].map((item, i) => (
            <div key={item.step} className="p-4 rounded-xl border border-emerald-500/20 bg-emerald-500/5 backdrop-blur-sm">
              <div className="text-[10px] font-bold text-emerald-500 uppercase tracking-widest mb-2 flex items-center gap-2">
                <span className="flex h-4 w-4 items-center justify-center rounded-full bg-emerald-500/20 text-[8px]">{i + 1}</span>
