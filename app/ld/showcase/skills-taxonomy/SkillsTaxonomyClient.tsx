    ...
    <section className="relative overflow-hidden px-5 pt-32 pb-16 bg-[#030303]">
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-10 max-w-4xl">
          ...
          >
            Mapping Talent <br />
            <span className="text-emerald-400 italic font-serif">Ecosystems.</span>
          </motion.h1>
          <motion.p
          ...
          >
            Architecting dynamic skills taxonomies, resilient succession plans, and seamless talent mobility pipelines for enterprise agility.
          </motion.p>
        </div>
      </div>
    </section>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <Reveal>
          ...
          <div className="space-y-6 text-lg text-neutral-400 leading-relaxed font-light">
            <p>
              In today's rapidly evolving market, job titles are becoming obsolete. 
              The future of organizational design lies in deconstructing roles into their atomic components: <span className="text-white font-medium">skills</span>.
            </p>
            <p>
              My practice centers on performance consulting and architectural talent strategy. By engineering comprehensive 
              <span className="text-emerald-400 font-medium mx-1">Skills Taxonomies</span> and linking them to 
              <span className="text-white font-medium italic mx-1">Talent Mobility</span> engines, 
              I enable organizations to identify latent capabilities, bridge critical skill gaps, and build robust succession pipelines that ensure continuity at the highest levels.
            </p>
            <p className="border-l-2 border-emerald-500/50 pl-6 py-2 italic text-emerald-50/90 bg-emerald-500/5 rounded-r-lg">
              &quot;We aren't just filling seats; we are mapping the organizational genome to dynamically deploy capability exactly where the strategy demands it.&quot;
            </p>
          </div>
        </Reveal>
      </div>
  ...
  const tools = [
    {
      ...
      subtitle: "The Capability Ontology",
      description: (
        <span>
          A living framework mapping the entire organizational capability matrix. By standardizing skill definitions and leveling across business units, we create a common language for talent, enabling data-driven hiring, development, and deployment decisions.
        </span>
      ),
      icon: Layers,
      colSpan: "lg:col-span-2",
      tags: ["Ontology", "Competency Mapping", "Data Strategy"],
      status: "Enterprise Scale",
    },
    {
      id: "succession-planning",
      title: "Succession Planning Matrix",
      subtitle: "Continuity Architecture",
      description: "Rigorous 9-box grids and potential assessments to identify, nurture, and prepare high-potential talent for critical leadership roles, mitigating organizational risk.",
      icon: ShieldCheck,
      colSpan: "lg:col-span-1",
      tags: ["9-Box", "Leadership", "Risk Mitigation"],
      status: "Active",
    },
    {
      ...
      description: "Strategic advisory aligning human capability with business goals. Diagnosing performance gaps through Gilbert's BEM to deliver solutions that impact the bottom line, rather than just delivering training.",
      icon: Activity,
      colSpan: "lg:col-span-1",
      tags: ["BEM", "Diagnostic", "Advisory"],
      status: "Strategic",
    },
    {
      id: "talent-mobility",
      title: "Talent Mobility Engine",
      subtitle: "Internal Opportunity Pipeline",
      description: "Architecting the systems and processes that allow talent to flow fluidly across the organization. Mapping skill adjacencies to transition employees from declining roles into high-demand areas seamlessly.",
      icon: Workflow,
      colSpan: "lg:col-span-2",
      tags: ["Internal Mobility", "Upskilling", "Adjacency Mapping"],
      ...
      <div className="mx-auto max-w-6xl">
        <Reveal className="mb-16">
          ...
          <h2 className="text-4xl font-bold tracking-tight text-white sm:text-5xl">
            The Talent Architecture <span className="italic font-serif text-emerald-400">Toolkit.</span>
          </h2>
        </Reveal>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <Reveal>
            ...
            <h2 className="text-4xl font-bold tracking-tight text-white sm:text-5xl mb-8 leading-tight">
              Designing Internal <br />
              <span className="text-emerald-400 italic font-serif">Mobility.</span>
            </h2>
            <p className="text-lg text-neutral-400 leading-relaxed font-light mb-8">
              True organizational agility isn't about hiring faster; it's about deploying existing talent smarter. I design full-stack ecosystems that map capabilities, predict gaps, and route high-potential talent to critical roles.
            </p>
            
            <div className="space-y-4">
              {[
                { title: "Dynamic Skill Mapping", desc: "Real-time visibility into the organization's capability graph.", icon: Network },
                { title: "Performance & Potential", desc: "Calibrated 9-box diagnostics for strategic succession.", icon: ShieldCheck },
                { title: "Strategic Talent Pipelines", desc: "Targeted development pathways for future leaders.", icon: Rocket },
              ].map((item, i) => (
...
/* ---------- 4. Mobility Command Center ---------- */
type CommandTab = "succession" | "taxonomy";
type CommandState = "idle" | "diagnostic" | "engineering" | "designing" | "complete";
type TaxonomyState = "idle" | "crystallizing" | "forging" | "validating" | "complete";

function CommandCenterSection() {
  const [activeTab, setActiveTab] = useState<CommandTab>("succession");
  const [state, setState] = useState<CommandState>("idle");
  const [taxonomyState, setTaxonomyState] = useState<TaxonomyState>("idle");
  const reduced = useReducedMotion();

  const tabs: { id: CommandTab; label: string }[] = [
    { id: "succession", label: "Succession & Mobility" },
    { id: "taxonomy", label: "Taxonomy Generation" },
  ];
  ...
  const states: { id: CommandState; label: string; icon: any }[] = [
    ...
    { id: "engineering", label: "2. Adjacencies", icon: Brain },
    { id: "designing", label: "3. Pipeline", icon: Layers },
      ...
      <div className="mx-auto max-w-6xl relative z-10">
        <Reveal className="mb-16">
          ...
          <h2 className="text-4xl font-bold tracking-tight text-white sm:text-5xl mb-6 leading-tight">
            Talent Flow & Continuity
          </h2>
          <p className="text-lg text-neutral-400 leading-relaxed font-light max-w-3xl">
            Watch as organizational capability data is vectorized, skill adjacencies are mapped, and dynamic succession pipelines are engineered in real time.
          </p>
        </Reveal>
        ...
        {activeTab === "succession" ? (
          ...
          <TaxonomyPipelineDemo state={taxonomyState} setState={setTaxonomyState} />
        )}
      </div>
    </section>
  );
...
/* ---------- 5. Taxonomy Generation Pipeline ---------- */
function TaxonomyPipelineDemo({ state, setState }: { state: TaxonomyState; setState: (s: TaxonomyState) => void }) {
  const reduced = useReducedMotion();

  const states: { id: TaxonomyState; label: string; icon: any }[] = [
