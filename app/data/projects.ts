...
export const projectsData: Project[] = [
  ...
  },
  {
    ...
    description: 'A mission-critical reinforcement layer implementing a 3-stage Reality Check Engine and a hierarchical cognitive memory system to eliminate agentic hallucinations.',
  ...
  },
  {
    ...
    name: 'LocalMind',
    shortName: 'LocalMind',
    tagline: 'Local RAG Intelligence',
    description: 'A high-performance local RAG system that enables natural language interaction with your desktop files, documents, and codebases—entirely offline and grounded in your personal data.',
    ...
    technologies: ['Python', 'Gemini', 'ChromaDB', 'RAG', 'Hybrid Search', 'CLI', 'RRF', 'pdfplumber', 'trafilatura'],
    techCategories: [
      { name: 'Core', items: ['Python', 'Incremental Indexing'], color: '#22d3ee' },
      { name: 'Search', items: ['Hybrid Search', 'RRF', 'ChromaDB'], color: '#14b8a6' },
      { name: 'AI Layer', items: ['Gemini Embeddings', 'Gemini Generation'], color: '#a78bfa' },
      { name: 'Parsing', items: ['Multi-format Parsing'], color: '#f472b6' },
    ],
    keyInnovations: [
    ...
    metrics: [
      { id: 'indexing-speed', label: 'Indexing Speed', value: 1000, unit: 'files/min', description: 'After initial run', color: '#22d3ee' },
      { id: 'latency', label: 'Retrieval Latency', value: 1, unit: 's', description: 'p99 end-to-end', color: '#14b8a6' },
    ],
    results: [
      { metric: 'Indexing', value: '1000+', context: 'files per minute' },
      { metric: 'Latency', value: '<1s', context: 'Retrieval' },
      { metric: 'Formats', value: '12+', context: 'Supported file types' },
