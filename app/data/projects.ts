...
export const projectsData: Project[] = [
  ...
  },
  {
    ...
    tagline: 'AI-Powered Learning Infrastructure',
    description: 'An AI-powered educational technology ecosystem engineered to solve the $1.2T Talent Paradox by replacing fragmented legacy tools with unified, intelligent infrastructure.',
    whatItDoes: 'Smartslate completely replaces the traditional 7-15 tool L&D stack through three interconnected platforms: Solara (unified learning lifecycle), Ignite (classroom-to-career talent verification), and Strategic Skills Architecture (bespoke enterprise solutions).',
    howItWorks: 'The Solara platform utilizes a multi-agent orchestration layer to automate stakeholder discovery into Learning Blueprints (Polaris) in 45 seconds, while subsequent modules handle AI-assisted content curation (Constellation), authoring (Nova), personalized delivery (Orbit), and 24/7 intelligent tutoring (Nebula).',
