...
export const projectsData: Project[] = [
  ...
  },
  {
    ...
    shortName: 'Agency',
    tagline: 'Multi-Agent Workflow Builder',
    description: 'Enterprise-grade platform for designing and deploying complex AI agent workflows with human-in-the-loop oversight.',
    whatItDoes: 'Agency Intelligence provides a drag-and-drop interface for building agentic workflows. It supports state persistence, parallel execution, and complex branching logic using LangGraph.',
    howItWorks: 'The platform is built on Next.js 15 and FastAPI. It uses a custom graph visualizer to represent LangGraph nodes and edges, allowing users to monitor state transitions in real-time.',
    technologies: ['Next.js 15', 'FastAPI', 'LangGraph', 'PostgreSQL', 'Redis', 'Tailwind CSS', 'Framer Motion', 'React Flow'],
    techCategories: [
      { name: 'Core', items: ['Next.js', 'FastAPI', 'LangGraph'], color: '#a78bfa' },
      { name: 'State', items: ['PostgreSQL', 'Redis'], color: '#f472b6' },
      { name: 'UI/UX', items: ['Tailwind', 'React Flow', 'Framer Motion'], color: '#22c55e' },
    ],
    keyInnovations: [
      'Visual state-machine debugger for LangGraph',
      'Dynamic agent-to-agent tool sharing',
      'Hierarchical Multi-Agent orchestration patterns',
    ],
    processFlow: [
      'Define State Schema',
      'Add Agent Nodes',
    ...
    metrics: [
      { id: 'efficiency', label: 'Efficiency', value: 45, unit: '%', description: 'Reduction in manual effort', color: '#a78bfa' },
      { id: 'throughput', label: 'Throughput', value: 120, unit: 'req/s', description: 'Concurrent agent runs', color: '#f472b6' },
    ],
    theme: {
      primary: '#a78bfa',
      secondary: '#f472b6',
    ...
    category: 'Agentic Systems',
    challenge: 'Simplifying the deployment of complex agentic workflows for non-technical users while maintaining granular control over state and execution logic.',
    solution: 'Built a visual low-code environment that maps directly to LangGraph primitives, providing a seamless bridge between visual design and production-ready Python code.',
    results: [
      { metric: 'Setup Time', value: '-80%', context: 'faster deployment' },
      { metric: 'Reliability', value: '99.9%', context: 'with state recovery' },
    ],
    duration: '4 Months',
  },
  {
    ...
    techCategories: [
      { name: 'AI Layer', items: ['GPT-4', 'Critic Agents'], color: '#fb923c' },
  ...
  },
  {
    ...
    techCategories: [
      ...
      { name: 'Intelligence', items: ['GPT-4', 'Adaptive Logic'], color: '#22c55e' },
