...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    duration: "8 months",
    testimonial: { quote: "The HITL pipeline transformed how we approach learning design. What used to take weeks now happens in hours with better quality.", author: "L&D Director", role: "Head of Learning", company: "Smartslate" },
  },
  {
    ...
    fullDescription: "Reality-Check traverses all agent directories, injects protocol references into AGENTS.md files, and establishes centralized GLOBAL_PROTOCOLS.md mandates. Each agent is instructed to verify before reporting, cite sources, say UNKNOWN when uncertain, and never simulate data. The system achieved 96% fleet coverage (141 of 147 agents) within minutes of deployment.",
    results: [
