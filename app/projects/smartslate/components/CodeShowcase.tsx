...
export function CodeShowcase() {
  ...
  return (
    <section className="py-6 sm:py-8 px-4 sm:px-6 md:px-8 relative overflow-hidden text-slate-200">
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          <p className="text-cyan-400 font-mono text-xs sm:text-sm tracking-widest uppercase mb-4">Infrastructure</p>
          <h2 className="text-3xl sm:text-5xl font-bold mb-6 tracking-tight text-white">The Solara Engine</h2>
          <p className="text-slate-400 max-w-2xl text-base sm:text-lg leading-relaxed">
            Multi-agent orchestration and automated lead capture systems built on Next.js 15 and Supabase.
          </p>
        </motion.div>
