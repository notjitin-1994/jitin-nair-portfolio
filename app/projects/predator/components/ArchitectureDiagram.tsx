...
const architectureSteps = [
  ...
  },
  {
    ...
    number: '05',
    title: 'TimescaleDB',
    subtitle: 'System SSOT',
    description: 'High-performance time-series foundation. Stores all ticks, signals, and agent states. Hypertable compression enables years of historical retention.',
    icon: Database,
    color: '#fb923c',
    stats: [
      { label: 'Compression', value: '12x' },
      { label: 'Query', value: '<5ms' },
    ],
  },
  {
    id: 'dashboard',
    ...
    description: 'Next.js 15 dashboard with dual-independent scroll and real-time WebSocket synchronization for sub-100ms state updates.',
    icon: Rocket,
    color: '#ef4444',
    stats: [
      { label: 'Refresh', value: '60fps' },
