  ...
  return (
    <section className="py-6 sm:py-8 px-4 sm:px-6 md:px-8 relative overflow-hidden">
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          <p className="text-cyan-400 font-mono text-xs sm:text-sm tracking-widest uppercase mb-4">Core Algorithms</p>
          <h2 className="text-3xl sm:text-5xl font-bold mb-6 tracking-tight">The Governance Logic</h2>
          <p className="text-slate-400 max-w-2xl text-base sm:text-lg leading-relaxed">
            Reality-Check enforcement and Dreamcycle memory management implemented as zero-latency TypeScript hooks within the OpenClaw Gateway.
          </p>
        </motion.div>

        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 min-h-[500px]">
          {/* Navigation - Sidebar on Desktop, Top on Mobile */}
