    ...
    <section className="py-6 sm:py-8 px-4 sm:px-6 md:px-8 relative overflow-hidden text-slate-200">
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-5xl font-bold mb-6 tracking-tight text-white">Institutional Workflow</h2>
          <p className="text-slate-400 max-w-2xl text-base sm:text-lg leading-relaxed">
            RevvOS logic is engineered for high-concurrency garage environments, prioritizing data persistence and cross-tenant security.
          </p>
        </motion.div>
